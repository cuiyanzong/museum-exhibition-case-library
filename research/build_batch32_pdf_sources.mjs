...
const pdfRoot = path.join(root, 'research/expansion_1000_batch32_pdfs');
const assetFsRoot = '/home/ubuntu/webdev-static-assets/expansion-1000-batch32';
const assetRoot = '/webdev-static-assets/expansion-1000-batch32';
...
function makeMain(entry, content) {
  ...
  return `// 第32批田野档案室PDF。仅使用人工审核的已建成展厅摄影与可追溯责任链。
