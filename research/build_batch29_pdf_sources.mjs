...
const assetFsRoot = '/home/ubuntu/webdev-static-assets/expansion-1000-batch29';
const assetRoot = '/webdev-static-assets/expansion-1000-batch29';
...
function makeMain(entry, content) {
  ...
  return `// 第29批田野档案室PDF。只使用经人工审核的已建成展厅摄影与可追溯责任链。
...
for (const content of contents) {
  ...
  const manifest = { task_kind: 'new-document', output: 'pdf', signals: [], hard_constraints: [], content_features: { code_blocks: 0, defined_terms: 0, portrait_images: 0 } };
